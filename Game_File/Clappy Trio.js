...
let TrioReady = [ 45, 420, 725, 860, 1045, 1255, 1340, 1570, 1650, 1860, 1955, 2110, 2220, 2525, 2855, 3020, 3610, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000];
let Trio1Clap = [120, 460, 765, 900, 1080, 1270, 1380, 1590, 1690, 1880, 1995, 2130, 2300, 2605, 2895, 3055, 3685, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000];
let Trio2Clap = [195, 500, 805, 920, 1115, 1285, 1420, 1610, 1730, 1900, 2035, 2150, 2380, 2685, 2935, 3090, 3760, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000];
let Trio3Clap = [270, 540, 845, 940, 1150, 1300, 1460, 1630, 1770, 1920, 2075, 2170, 2460, 2765, 2975, 3125, 3835, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000];
let Trio3ClapTAD = [];
...
function update() {
	frame = parseInt(Title_music.currentTime * 60 + 0.4);
	
	TTC();

    if(74 in keysDown){
		if(!is_A_press){
			Trio3ClapTAD.push(frame * 1.25 + 22);
			T3P = 2;
		}
